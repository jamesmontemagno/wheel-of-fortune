...
- **Bankrupt** grows with the rounds: one wedge in round one, two in round two, three in round three, and four in round four. It never lands twice in a row. It clears only current round winnings and held prizes. **Lose a Turn** preserves them. Both pass play to the next person.
